...
const CoachDashboard = () => {
    ...
    useEffect(() => {
        // Keep form fields in sync when user data changes.
    ...
    const downloadRosterCsv = () => {
        ...
        for (const slot of slots) {
            ...
            if (slot.bookings && slot.bookings.length > 0) {
                ...
                // Keep an entry for the slot even when there are no bookings.
                lines.push(
                    [
                        slotDate,
                        start,
                ...
                {activeTab === 'announcements' && (
                    <div className="max-w-4xl mx-auto space-y-8">
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm">
                            ...
                            <p className="text-slate-500 text-sm mb-6">This will appear in the student notices feed as a Coach notice.</p>
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm">
                            <div className="flex items-center justify-between gap-4 mb-6">
                                <h3 className="text-xl font-black text-slate-800">Your Recent Coach Notices</h3>
                                <button
                                    type="button"
                ...
                {activeTab === 'profile' && (
                    <div className="max-w-3xl mx-auto space-y-8">
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm">
                            ...
                            <p className="text-slate-500 text-sm mb-6">Update your specialization and availability. This will show on the Landing page coach cards.</p>
                            ...
                            <form onSubmit={handleSaveProfile} className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2">Availability / Schedule</label>
                                    <input
                        ...
                        <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-sm">
                            <h3 className="text-xl font-black text-slate-800 mb-2">Contact Shortcuts</h3>
                            <p className="text-slate-500 text-sm mb-6">Quick ways to reach the admin team.</p>
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button
                                    type="button"
                                    onClick={() => { window.location.href = '/#contact'; }}
                                    className="px-5 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 font-black uppercase tracking-widest text-[10px] hover:bg-white transition-all"
                                >
                                    Open Contact Form
                                </button>
                                <button
